...
cursor.execute(
    """
    create table if not exists readingshort(
...
cursor.execute(
    """
    insert into readingshort(material,chinese,questions,options,answers,explanations) values(?,?,?,?,?,?)
    """
    ,
